...
public class CameraFollow : MonoBehaviour
{
    ...
    public GameObject cameaBottomBorder;
    ...
    void Start()
    {
        ...
        cameraHalfLength = Camera.main.orthographicSize;
    }
    ...
    void FixedUpdate()
    {
        ...
        float borderBottom = cameaBottomBorder.transform.position.y + cameraHalfLength;
        float borderTop = cameraTopBorder.transform.position.y - cameraHalfLength;
